...
/**
 * 重点单位单选
 * @param unitId 点击确认时回写unitId值的地方
 * @param unitName 点击确认时回写deptName值的地方
 * @param checkedIds 默认选中的重点单位
 */
function unitRadioDiaLog(deptId, deptName, checkedIds) {//ids默认选中：4
	$('#content').parent().append('<div id="loading" class="center">Loading...<div class="center"></div></div>');
	$.ajax({
		type : "post",
		url : cxt + "/jf/platform/unit/toUrl",
		data : { "toUrl" : "/platform/unit/radio.html", "ids" : checkedIds, "deptId" : deptId, "deptName" : deptName },
		dataType : "html",
		contentType: "application/x-www-form-urlencoded; charset=UTF-8",
		async: false,
		success:function(data){
	...
	$.ajax({
		type : "post",
		url : cxt + "/jf/platform/unit/toUrl",
		data : { "toUrl" : "/platform/unit/radio.html", "ids" : checkedIds, "unitId" : unitId, "unitName" : unitName },
		dataType : "html",
		contentType: "application/x-www-form-urlencoded; charset=UTF-8",
		async: false,
		success:function(data){
 ...
 * @param checkedIds
 */
function devtypeRadioDiaLog(stationId, stationName, checkedIds){
	$('#content').parent().append('<div id="loading" class="center">Loading...<div class="center"></div></div>');
	$.ajax({
		type : "post",
		url : cxt + "/jf/platform/devtype/toUrl",
		data : { "toUrl" : "/platform/devtype/radio.html", "ids" : checkedIds, "stationId" : stationId, "stationName" : stationName },
		dataType : "html",
		contentType: "application/x-www-form-urlencoded; charset=UTF-8",
		async: false,
		success:function(data){
 ...
 * @param checkedIds
 */
function devvendorRadioDiaLog(stationId, stationName, checkedIds){
	$('#content').parent().append('<div id="loading" class="center">Loading...<div class="center"></div></div>');
	$.ajax({
		type : "post",
		url : cxt + "/jf/platform/devvendor/toUrl",
		data : { "toUrl" : "/platform/devvendor/radio.html", "ids" : checkedIds, "stationId" : stationId, "stationName" : stationName },
		dataType : "html",
		contentType: "application/x-www-form-urlencoded; charset=UTF-8",
		async: false,
		success:function(data){
...
function setRoleOperatorDiaLog(roleIds){
	...
	newNode.innerHTML = '<div id="loading" class="center">Loading...<div class="center"></div></div>';
	
	$('#content').parent().append(newNode);
	$.ajax({
		type : "post",
		url : cxt + "/jf/platform/operator/toUrl",
