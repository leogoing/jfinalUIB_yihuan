...
public class ThreadParamInit extends Thread {
	...
	public static String cacheStart_unit = "unit_";
	public static String cacheStart_unitpic = "unitpic_";
	public static String cacheStart_devvendor = "devvendor_";
	public static String cacheStart_devtype = "devtype_";
